...
namespace DirectoryService.Migrations
{
    ...
    [Migration("20251104160010_AddingQueueEntity")]
    partial class AddingQueueEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DirectoryService.Models.Entities.Queue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("DirectoryService.Models.Entities.QueueSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("MinutesAfterPending")
                        .HasColumnType("integer");

                    b.Property<int>("MinutesBeforePending")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DirectoryService.Models.Entities.QueueSettings", b =>
                {
                    b.HasOne("DirectoryService.Models.Entities.Queue", "Queue")
                        .WithOne("QueueSettings")
                        .HasForeignKey("DirectoryService.Models.Entities.QueueSettings", "QueueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
